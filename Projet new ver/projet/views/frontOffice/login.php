...
<body>
    <div class="main">
        ...
        <div class="signup">
            ...
            <form id="signup-form" method="POST" action="/projet/views/frontOffice/index.php?action=signup">
        ...
        <div class="login">
            ...
            <form id="signup-form" method="POST" action="/projet/views/frontOffice/index.php?action=signin">
